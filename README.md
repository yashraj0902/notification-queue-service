...
Open your browser and go to http://localhost:8080/swagger-ui.html. You'll see a nice graphical interface where you can click around, create new notifications, and test all the API endpoints without writing any code.
